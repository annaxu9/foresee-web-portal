      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        <div className="mb-8">
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-4xl mx-auto leading-relaxed">
            Welcome to the official site for FORSEE, a powerful open-source framework designed to accelerate and streamline the development and evaluation of neural signal processing pipelines for brain-computer interfaces (BCIs).
          </p>
        </div>
        
        <div className="mb-12">
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8">
            FORSEE enables seamless co-design between algorithmic development in Python and hardware description in Verilog, offering researchers and engineers a unified, intuitive platform to iterate and explore.
          </p>
        </div>
